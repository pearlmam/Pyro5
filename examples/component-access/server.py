...
class ExposeComps:
    ...
    def __exposed_comps__(self):
        """Allows reading from _exposedComps attribute over a Proxy """
    ...
    def __is_exposed__(self,name):
        """Checks if comp is exposed"""
        return  name in getattr(self,'_exposedComps',[])
